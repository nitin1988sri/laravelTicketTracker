                  ...
                  <div class="col-lg-6">
                     <div class="card">
                        ...
                        <div class="card-block">
							{{ Form::model($data, array('route' => array('ticket-type.update', $data->id), 'method' => 'PUT')) }}
							{{ csrf_field() }}
                              <div class="form-group">
                                 <label for="exampleInputEmail1" class="form-control-label"></label>
                                 <input type="text" class="form-control" name="ticket_type" id="ticket_type" value="{{$data->ticket_type}}">
                              </div>
