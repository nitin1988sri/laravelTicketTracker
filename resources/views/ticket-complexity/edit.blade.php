                  ...
                  <div class="col-lg-6">
                     <div class="card">
                        <div class="card-header">
                           <h5 class="card-header-text">Ticket complexity</h5>
                           <div class="f-right">
                        ...
                        <div class="card-block">
							{{ Form::model($data, array('route' => array('ticket-complexity.update', $data->id), 'method' => 'PUT')) }}
							{{ csrf_field() }}
                              <div class="form-group">
                                 <label for="exampleInputEmail1" class="form-control-label"></label>
                                 <input type="text" class="form-control" name="complexity" id="complexity" value="{{$data->complexity}}">
                              </div>
