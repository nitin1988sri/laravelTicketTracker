            ...
            <div class="row dashboard-header">
               <div class="col-lg-3 col-md-6">
                  <div class="card dashboard-product">
                     <span>Picked Ticket</span>
                     <h2 class="dashboard-total-products">285</h2>
                     <span class="label label-danger">Take tour</span>
               ...
               <div class="col-lg-3 col-md-6">
                  <div class="card dashboard-product">
                     ...
                     <h2 class="dashboard-total-products">10</span></h2>
                     <span class="label label-danger">Take tour</span>
                     <div class="side-box">
